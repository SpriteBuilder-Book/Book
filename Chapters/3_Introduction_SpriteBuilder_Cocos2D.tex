...
start adding some content to it. During this exercise we will create a small
first project that will teach you all of the following:
\begin{itemize}
  \item Creating scenes in \SB{}
  \item Creating code connections
\end{itemize}
