...
\begin{figure}[H]
		\centering
		\includegraphics[width=0.95\linewidth]{images/spritebuilder/spritebuilder_fileview.png}     
\end{figure} 
...
\begin{figure}[H]
		\centering
		\includegraphics[width=0.95\linewidth]{images/spritebuilder/spritebuilder_nodeview.png}     
\end{figure} 
...
\begin{leftbar}
\begin{enumerate}
\item Open \textit{MainScene.swift} in \xcode{}. 
...
\inlinecode{onEnter} to \textit{Square.swift}:
\begin{lstlisting}
...
\begin{leftbar}
Add the following lines to the \inlinecode{onEnter} method of
\textit{Square.swift} to make the square rotate endlessly:
\begin{lstlisting}
