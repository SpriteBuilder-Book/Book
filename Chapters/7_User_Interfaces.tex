...
\begin{leftbar}
Select the our \textit{Start!} button and open the \textit{Code Connections}
tab.
\end{leftbar}

We have discussed how we can set up methods that are called upon button clicks
in the \cocos{} and \SB{} introduction chapter (\ref{target_selector}).
