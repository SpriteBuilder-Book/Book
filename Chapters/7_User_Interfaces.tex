...
protocol GameModeDelegate: class {
  ...
  func gameplayStep(mainScene:MainScene, delta: CCTime) -> Bool
}
\end{lstlisting}
\end{leftbar}
...
the \inlinecode{Bool} return value. The return value allows the game mode to
...
Now there's only one last method to implement, the \inlinecode{}
