...
var gameMode:GameMode = .Endless {
  didSet {
    ...
    gameModeDelegate?.userInterface.zOrder = Int.max
  }
}
\end{lstlisting}
\end{leftbar}
...
game mode UI to \inlinecode{Int.max}, which means that the UI will be rendered
above all other elements in this scene.
...
\section{Adding a game end popup}
