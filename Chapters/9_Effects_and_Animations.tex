...
\begin{enumerate}
  ...
  \item Set the normal map to \filemention{assets\/pot-top_NRM.png}
  \item Select \textit{pot-bottom} in the timeline
  \item Set the normal map to \filemention{assets\/pot-bottom_NRM.png}
\end{enumerate}
\end{leftbar}
...
of how your lighting effects are working you'll need to run your game.
