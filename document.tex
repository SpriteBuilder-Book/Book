...
\PassOptionsToPackage{hyphens}{url}\usepackage[colorlinks=true, linkcolor =
MidnightBlue, urlcolor  = MidnightBlue, citecolor = MidnightBlue]{hyperref}
...
\cleardoublepage{}
\tableofcontents{}
%http://tex.stackexchange.com/questions/111338/inserting-a-blank-left-starting-page-in-a-koma-script-book
